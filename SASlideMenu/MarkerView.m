...
#define LABEL_MARGIN        25
#define DISCLOSURE_MARGIN   12
...
- (id)initForCoordinate:(ARGeoCoordinate *)coordinate withDelgate:(id<ARMarkerDelegate>)aDelegate allowsCallout:(BOOL)allowsCallout{
   ...
   _coordinateInfo = coordinate;
	...
	CGRect theFrame             = CGRectMake(20, 0, calloutSize.width, calloutSize.height);
	...
	if(self = [super initWithFrame:theFrame]){
        ...
        UILabel *titleLabel	= [[UILabel alloc] initWithFrame:CGRectMake(50, LABEL_MARGIN -15, labelSize.width + 20, labelSize.height - 5)];
		[titleLabel setBackgroundColor: [UIColor clearColor]];
		[titleLabel setTextColor:		[UIColor whiteColor]];
		[titleLabel setTextAlignment:	NSTextAlignmentLeft];
        [titleLabel setFont:            [UIFont fontWithName:@"Helvetica-Bold" size:13]];
        ...
        _lblDistance = [[UILabel alloc] initWithFrame:CGRectMake(20, 25, labelSize.width, labelSize.height - 5)];
        ...
        [_lblDistance setFont:               [UIFont fontWithName:@"Helvetica" size:12.0]];
		if(_usesMetric == YES){
        ...
        if(_allowsCallout){
           UIImageView *disclosureImageView = [[UIImageView alloc] initWithFrame:CGRectMake(calloutSize.width - disclosureImage.size.width - DISCLOSURE_MARGIN, DISCLOSURE_MARGIN,
                                                disclosureImage.size.width, disclosureImage.size.height + 5)];
            [disclosureImageView setImage:[UIImage imageNamed:@"chevron copy.png"]];
