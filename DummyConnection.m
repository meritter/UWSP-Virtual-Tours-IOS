...
- (void)startUploadProgress {
	...
	[self performSelector:@selector(setUploadProgress:) withObject:[NSNumber numberWithFloat:0.3] afterDelay:1.2];
	
	[self performSelector:@selector(setUploadProgress:) withObject:[NSNumber numberWithFloat:0.6] afterDelay:1.2];
	
	[self performSelector:@selector(setUploadProgress:) withObject:[NSNumber numberWithFloat:0.7] afterDelay:1.1];
	
	[self performSelector:@selector(setUploadProgress:) withObject:[NSNumber numberWithFloat:1.0] afterDelay:2];
}
